...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// 
			this->‰ÂÈÒÚ‚ËˇToolStripMenuItem->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(1) { this->ÓÚ‰ÓıÌÛÚ¸ŒÚ–‡·ÓÚ˚ToolStripMenuItem });
			...
			this->ÓÚ‰ÓıÌÛÚ¸ŒÚ–‡·ÓÚ˚ToolStripMenuItem->Click += gcnew System::EventHandler(this, &MyForm::ÓÚ‰ÓıÌÛÚ¸ŒÚ–‡·ÓÚ˚ToolStripMenuItem_Click);
			// 
			...
			this->adm_label->Text = L"œ‡ÓÎ¸ ‰Îˇ ‚ıÓ‰‡ ‚ admin";
			// 
			// admin_textbox
			// 
...
private: System::Void ÓÚ‰ÓıÌÛÚ¸ŒÚ–‡·ÓÚ˚ToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e) {
		this->Hide();
...
private: System::Void admin_mode_button_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	try {
		...
		MessageBox::Show("Œ¯Ë·Í‡ ÓÚÍ˚ÚËˇ Ù‡ÈÎ‡ Ò Ô‡ÓÎÂÏ: " + ex->Message);
		return;
	}

	// ”·Ë‡ÂÏ ‚ÓÁÏÓÊÌ˚Â ÔÓ·ÂÎ˚ Ë ÒËÏ‚ÓÎ˚ ÌÓ‚ÓÈ ÒÚÓÍË ËÁ Ô‡ÓÎˇ
	...
	if (this->admin_textbox->Text == "123") {
		...
		MessageBox::Show("ÕÂÍÓÂÍÚÌ˚È Ô‡ÓÎ¸");
	}
}
